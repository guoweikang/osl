...
impl GeneralI2cMsg for I2cMsg {
    ...
    fn new_send<const N: usize>(addr: u16, flags: I2cMsgFlags, data: [u8;N]) -> I2cMsg {
    ...
    fn new_recieve(addr: u16, flags: I2cMsgFlags, len: usize) -> I2cMsg {
         assert!(flags.contains(I2cMsgFlags::I2cMasterRead));
         I2cMsg { addr, flags, buf: VecDeque::with_capacity(len), recieve_threshold: len, recieve_cmd_cnt: 0}
    }
    ...
    fn modify_recieve_cmd_cnt(&mut self, recieve_cmd_cnt: isize) {
    ...
    fn recieve_end(&self) -> bool {
        // MasterRead means msg can be write
        assert!(self.flags.contains(I2cMsgFlags::I2cMasterRead));
        self.buf.len() == self.recieve_threshold
    }
    ...
    fn modify_recieve_threshold(&mut self, buf_len: usize) {
        assert!(self.flags.contains(I2cMsgFlags::I2cMasterRecvLen));
        self.recieve_threshold = buf_len;
    }
}
